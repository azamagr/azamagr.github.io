...
const CATEGORIES = [
  {
    name: "Frontend",
    items: [
      { name: "React.js", note: "Built production UIs across multiple MERN projects" },
      { name: "Tailwind CSS", note: "Utility-first styling for responsive layouts" },
      { name: "Bootstrap", note: "Rapid responsive prototyping" },
      { name: "JavaScript (ES6+)", note: "Core language for frontend development" },
      { name: "HTML5", note: "Semantic and accessible web structure" },
      { name: "CSS3", note: "Responsive layouts and modern styling" },
    ],
  },
  {
    name: "Backend",
    items: [
      ...
      { name: "Express.js", note: "REST API development and routing" },
      { name: "JWT", note: "Authentication & Authorization" },
      { name: "REST APIs", note: "Designed and integrated APIs" },
    ],
  },
  {
    name: "Databases",
    items: [
      { name: "MongoDB", note: "NoSQL database for MERN applications" },
      { name: "Mongoose", note: "ODM for MongoDB" },
      { name: "MySQL", note: "Relational database management" },
      { name: "SQL", note: "Database queries and normalization" },
    ],
  },
  {
    name: "Tools / Concepts",
    items: [
      ...
      { name: "MongoDB Compass", note: "MongoDB GUI for database management" },
      { name: "npm", note: "JavaScript package management" },
      { name: "MVC", note: "Application architecture pattern" },
      { name: "OOP", note: "Object-Oriented Programming concepts" },
      { name: "Responsive Design", note: "Mobile-first web development" },
    ],
  },
  {
    name: "Other Languages & Tools",
    items: [
      { name: "PHP", note: "Used in early full-stack projects" },
      { name: "Laravel", note: "PHP framework" },
      { name: "Python", note: "LinkedIn Learning Certified (Python Essential Training, Python OOP & Python 3 Standard Library)" },
      { name: "C++", note: "Object-Oriented Programming & Data Structures coursework" },
      { name: "WordPress", note: "DigiSkills Certified" },
    ],
  },
];
