...
export default function Footer() {
  ...
  return (
    <footer
      ref={ref}
      className="relative overflow-hidden bg-[#111111] pt-20 sm:pt-28"
    >
      <div className="mx-auto max-w-7xl px-6 sm:px-10">
        {/* Top: three columns */}
        <div className="grid grid-cols-1 gap-12 border-b border-white/10 pb-16 sm:grid-cols-3 sm:gap-8">
          ...
          <FooterColumn label="Availability" align="sm:text-right">
            ...
            <p className="mt-3 flex items-center gap-2 text-sm text-white/40 sm:justify-end">
        ...
        <div className="overflow-hidden py-14 sm:py-20">
          <motion.h2
            style={{ clipPath, x }}
            className="select-none whitespace-nowrap text-center text-[15vw] font-black leading-none tracking-tighter text-white sm:text-[10vw]"
          >
            muhammad azam
          </motion.h2>
        </div>
      ...
      <div className="border-t border-white/10">
        <div className="mx-auto flex max-w-7xl flex-col items-center gap-5 px-6 py-8 text-center sm:flex-row sm:justify-between sm:gap-0 sm:px-10 sm:text-left">
          ...
          <a
            ...
            className="text-sm font-medium text-white/80 underline decoration-white/30 underline-offset-4 transition-colors duration-300 hover:text-white hover:decoration-[#ff2a2a]"
          >
          ...
          <div className="flex items-center gap-5">
            <a
              ...
              rel="noreferrer"
              aria-label="GitHub"
              className="group text-white/60 transition-colors duration-300 hover:text-white"
            >
